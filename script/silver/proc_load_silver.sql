...
Script Purpose:
  ...
  Actions Performed:
    ...
    - Inserts transformed and leansed data from Bronze into Silver tables
...
BEGIN
    ...
    PRINT '==================================================';
    PRINT '      STARTING REFRESH PROCESS FOR SILVER LAYER   ';
    PRINT '==================================================';

    SET @start_time = GETDATE();
    SET @batch_start_time = GETDATE();
    ---------------------------------------------------------------------------
    -- 1. BẢNG: silver.crm_cust_info
    ---------------------------------------------------------------------------
    ...
    INSERT INTO silver.crm_cust_info (
        ...
        cst_first_name,
        cst_last_name,
        cst_material_status, -- Đã sửa chính tả từ material -> marital
        cst_gndr,
        cst_create_date
    )
    SELECT 
    ...
    ---------------------------------------------------------------------------
    -- 3. BẢNG: silver.crm_sales_detail
    ---------------------------------------------------------------------------
    PRINT '--------------------------------------------------';
    ...
    SELECT 
        ...
        END AS sls_due_dt,
        -- Đã đảo vị trí sls_sales và sls_quantity trong SELECT để khớp với thứ tự khai báo cột ở trên của bạn
    ...
    SELECT 
        ...
        cat,
        subcat,
        -- Đã lồng phần xử lý TRIM/REPLACE trực tiếp vào đây để tối ưu hiệu năng thay vì chạy lệnh UPDATE riêng
